...
EUREKA_INSTALL_IP=slave2        # Microservices Service Registration Discovery Center
EUREKA_PORT=20303
...
HIVE_META_URL=jdbc:mysql://master:3306/hive?characterEncoding=UTF-8
HIVE_META_USER=root
HIVE_META_PASSWORD=Wind@2019
