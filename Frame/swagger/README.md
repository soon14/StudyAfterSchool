...
```
package com.example.wjn.mypot.config;

import com.google.common.base.Predicate;
import com.example.wjn.mypot.annotation.SwaggerCustomIgnore;
...
@ComponentScan(basePackages = "com.example.wjn.mypot.controller")
...
```
package com.example.wjn.mypot.annotation;
