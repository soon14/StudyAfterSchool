...
参考
![image](https://github.com/wjn0918/Study/blob/master/BigData/images/cloudera/ntp_master.conf)

集群其它节点配置如下
参考
![image](https://github.com/wjn0918/Study/blob/master/BigData/images/cloudera/ntp_slave.conf)
