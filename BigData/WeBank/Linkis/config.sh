...
HIVE_META_URL=jdbc:mysql://192.168.10.191:3306/metastore?characterEncoding=UTF-8
HIVE_META_USER=hive
...
#EUREKA_INSTALL_IP=192.168.10.190         # Microservices Service Registration Discovery Center
EUREKA_PORT=20303

###  Gateway install information
GATEWAY_INSTALL_IP=192.168.10.190
GATEWAY_PORT=9001

###  publicservice
PUBLICSERVICE_INSTALL_IP=192.168.10.190
PUBLICSERVICE_PORT=9102


### Hive Metadata Query service, provide the metadata information of Hive databases.
METADATA_INSTALL_IP=192.168.10.190
METADATA_PORT=9103


### ResourceManager
RESOURCEMANAGER_INSTALL_IP=192.168.10.190
RESOURCEMANAGER_PORT=9104


### Spark
### This service is used to provide spark capability.
SPARK_INSTALL_IP=192.168.10.190
SPARK_EM_PORT=9105
...
HIVE_INSTALL_IP=192.168.10.190
HIVE_EM_PORT=9107
...
PYTHON_INSTALL_IP=192.168.10.190
PYTHON_EM_PORT=9109
